...
CUE_PRESETS: dict[str, tuple[CueTemplate, ...]] = {
    "starter": (
        CueTemplate(cue_label="Start", beat_index=0),
        CueTemplate(cue_label="2 Bars", beat_index=8),
        CueTemplate(cue_label="4 Bars", beat_index=16),
        CueTemplate(cue_label="8 Bars", beat_index=32),
        CueTemplate(cue_label="16 Bars", beat_index=64),
    ),
    "phrase": (
        CueTemplate(cue_label="Start", beat_index=0),
    ...
    "extended": (
        ...
        CueTemplate(cue_label="8 Bars", beat_index=32),
        CueTemplate(cue_label="16 Bars", beat_index=64),
        CueTemplate(cue_label="24 Bars", beat_index=96),
        CueTemplate(cue_label="32 Bars", beat_index=128),
    ),
    "performance": (
        CueTemplate(cue_label="Start", beat_index=0),
        CueTemplate(cue_label="8 Bars", beat_index=32),
        CueTemplate(cue_label="16 Bars", beat_index=64),
        CueTemplate(cue_label="32 Bars", beat_index=128),
        CueTemplate(cue_label="Chorus 2", time_fraction=0.55),
        CueTemplate(cue_label="Breakdown", time_fraction=0.68),
        CueTemplate(cue_label="Last Chorus", time_fraction=0.80),
        CueTemplate(cue_label="Outro", time_fraction=0.92),
    ),
    "minimix": (
